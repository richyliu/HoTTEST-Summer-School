...
bool-≡-char₂ true true bi = refl true
bool-≡-char₂ true false bi = 𝟘-elim (pr₁ bi ⋆)
bool-≡-char₂ false true bi = 𝟘-elim (pr₂ bi ⋆)
bool-≡-char₂ false false bi = refl false
```
